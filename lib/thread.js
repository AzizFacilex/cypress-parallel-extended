...
async function executeThread(thread, index) {
  ...
  console.log(`Thread ${index + 1}: Executing with ${thread.list.length} spec(s)`);
  if (settings.isVerbose) {
    console.log(`Thread ${index + 1} specs:`, thread.list);
    console.log(`Thread ${index + 1} command:`, [packageManager, ...commandArguments].join(' '));
  }
